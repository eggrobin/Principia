...
\marginpar{For $n=-2$, which has received particular attention, $\gg$ here corresponds to $2t-1$ in
[cite Robertson here], $2r_0-1$ in [cite Lomont here], $-3\gs$ in [cite McEniry here].
For $n=3$, $C_{n,\gg}$ corresponds to Kahan's $C$ [cite Kahan here].}
